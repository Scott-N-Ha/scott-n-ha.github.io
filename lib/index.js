...
function loadAdsScript() {
  const isProductionHost =
    window.location.hostname === "scott-n-ha.github.io" ||
    window.location.hostname === "www.scott-n-ha.github.io";
  ...
  script.async = true;
  script.src =
    "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-6173292899968944";
...
["pointerdown", "keydown", "scroll", "touchstart"].forEach((eventName) => {
  window.addEventListener(eventName, loadAdsOnce, {
    once: true,
    passive: true,
  });
});

window.setTimeout(loadAdsOnce, 8000);
